...
public class CoreConfig {
    ...
    private static void enableblock(Configuration cfg) {
        ...
        enableSteelBlock = cfg.getBoolean("steel block", CATEGORY_ENABLE_block, enableSteelBlock, COMMENT_ENABLE);
        enableTungstenBlock = cfg.getBoolean("tungsten block", CATEGORY_ENABLE_block, enableTungstenBlock, COMMENT_ENABLE);
    }
    ...
    private static void hardnessblock(Configuration cfg) {
        ...
        hardnessSteelBlock = cfg.getFloat("steel block hardness", CATEGORY_HARDNESS_block, hardnessSteelBlock, Integer.MIN_VALUE, Integer.MAX_VALUE, COMMENT_HARDNESS);
        hardnessTungstenBlock = cfg.getFloat("tungsten block hardness", CATEGORY_HARDNESS_block, hardnessTungstenBlock, Integer.MIN_VALUE, Integer.MAX_VALUE, COMMENT_HARDNESS);
    }
    ...
    private static void resistanceblock(Configuration cfg) {
        ...
        resistanceSteelBlock = cfg.getFloat("steel block resistance", CATEGORY_RESISTANCE_block, resistanceSteelBlock, Integer.MIN_VALUE, Integer.MAX_VALUE, COMMENT_RESISTANCE);
        resistanceTungstenBlock = cfg.getFloat("tungsten block resistance", CATEGORY_RESISTANCE_block, resistanceTungstenBlock, Integer.MIN_VALUE, Integer.MAX_VALUE, COMMENT_RESISTANCE);
    }
